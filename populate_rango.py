...
def populate():
    python_pages=[{"title":"Official Python Tutorial","url":"http://docs.python.org/2/tutorial/","views":0},
    ...
    django_pages=[{"title":"Official Django Tutorial","url":"https://docs.djangoproject.com/en/1.9/intro/tutorial01/","views":0},
                  {"title":"Django Rocks","url":"http://www.djangorocks.com/","views":0},
                  {"title":"How to Tango with Django","url":"http://www.tangowithdjango.com/","views":0}]

    other_pages=[{"title":"Bottle","url":"http://bottlepy.org/docs/dev/","views":0},
    ...
    for cat, cat_data in cats.items():
        ...
        for p in cat_data["pages"]:
            add_page(c,p["title"],p["url"],random.randint(0,128))
